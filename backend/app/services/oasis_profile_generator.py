...
class OasisProfileGenerator:
    ...
    def _get_system_prompt(self, is_individual: bool) -> str:
        """获取系统提示词"""
        base_prompt = "You are an expert in generating social media user profiles. Generate detailed, realistic personas for public opinion simulation, faithfully reproducing existing real-world conditions. You must return valid JSON format, and all string values must not contain unescaped newline characters. Use English."
        return base_prompt
    ...
    def _build_individual_persona_prompt(
        ...
        return f"""Generate a detailed social media user persona for the entity, faithfully reproducing existing real-world conditions.
...
"""
    ...
    def _build_group_persona_prompt(
        ...
        return f"""Generate a detailed social media account profile for an organization/group entity, faithfully reproducing existing real-world conditions.
...
2. persona: Detailed account profile description (2000 words of plain text), which should include:
   ...
   - Organizational memory (an important part of the account persona, describing this organization's connection to events, and its existing actions and reactions in those events)
