...
# Default activity pattern configuration (typical daily schedule)
...
class EventConfig:
    """Event configuration"""
    # Initial events (trigger events at the start of simulation)
...
- Follow typical daily activity patterns
...
- Peak evening hours 7-10 PM: highest activity (activity multiplier 1.5)
- After 11 PM: declining activity (activity multiplier 0.5)
- General pattern: low activity late night, gradually increasing in morning, moderate during work hours, peak in evening
- **Important**: The example values below are for reference only. You should adjust the specific time periods based on the nature of the event and characteristics of participant groups.
...
- reasoning (string): Brief explanation of why this configuration was chosen"""
    ...
    def _parse_time_config(self, result: Dict[str, Any], num_entities: int) -> TimeSimulationConfig:
        ...
        return TimeSimulationConfig(
            ...
            off_peak_activity_multiplier=0.05,  # Late night, almost no one active
...
- **Follow typical daily activity patterns**: almost no activity 0-5 AM, most active during peak evening hours 7-10 PM
...
{{
    ...
    def _generate_agent_config_by_rule(self, entity: EntityNode) -> Dict[str, Any]:
        """Generate a single Agent configuration based on rules (typical daily activity patterns)"""
        ...
        if entity_type in ["university", "governmentagency", "ngo"]:
            ...
            # General person: peak evening hours
            return {
                "activity_level": 0.7,
                "posts_per_hour": 0.5,
