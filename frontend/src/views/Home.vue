  ...
  <div class="home-container">
    ...
    <div class="main-content">
      ...
      <section class=”hero-section”>
        <div class=”hero-left”>
          <div class=”tag-row”>
            <span class=”orange-tag”>A Versatile Swarm Intelligence Engine</span>
          ...
          <div class=”hero-desc”>
            <p>
              Even from a single passage of text, <span class=”highlight-bold”>MiroFish</span> can extract real-world seeds and auto-generate a parallel world composed of up to <span class=”highlight-orange”>millions of Agents</span>. Inject variables from a god's-eye view and discover <span class=”highlight-code”>”locally optimal solutions”</span> through complex swarm interactions in dynamic environments.
            </p>
            <p class=”slogan-text”>
              Let the future rehearse among Agents; let decisions triumph after a thousand battles<span class=”blinking-cursor”>_</span>
            </p>
          </div>
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Dual-platform parallel simulation & auto-parsing prediction requirements & dynamic temporal memory updates</div>
                </div>
              </div>
              <div class="workflow-item">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Chat with any entity in the simulated world & converse with the ReportAgent</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Describe your simulation or prediction requirement in natural language (e.g., What public opinion trends would emerge if University X reverses the disciplinary action against a student?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
...
:root {
  ...
  --border: #E5E5E5;
  /*
    Using Space Grotesk as the primary heading font, JetBrains Mono for code/labels.
