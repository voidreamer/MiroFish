...
// Get maxRounds from query params at initialization so child components can access it immediately
...
const handleGoBack = async () => {
  // Before going back to Step 2, close the running simulation
...
const loadGraph = async (graphId) => {
  // During simulation, auto-refresh should not show fullscreen loading to avoid flickering
